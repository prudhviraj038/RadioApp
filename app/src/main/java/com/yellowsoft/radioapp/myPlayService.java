...
public class myPlayService extends Service implements OnCompletionListener,
    ...
    public static final String BROADCAST_ACTION = "com.yellowsoft.radioapp.seekprogress";

    // Set up broadcast identifier and intent
    public static final String BROADCAST_BUFFER = "com.yellowsoft.radioapp.broadcastbuffer";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        //  sntAudioLink = "http://clients.yellowsoft.in/dendan/uploads/songs/41453309981.mp3";
        mediaPlayer.reset();
    ...
    private void LogMediaPosition() {
        ...
        if (mediaPlayer.isPlaying()) {
            ...
            seekIntent.putExtra("ispaused", ispausedbtn);
