...
public class RadioChannelsAdapter extends BaseAdapter{
    String [] result;
    Context context;
    int [] imageId;
    ArrayList<ArtistModel> artists;
    RadioChannelsList artistListActivity;
    private static LayoutInflater inflater=null;
    public RadioChannelsAdapter(Activity mainActivity, ArrayList<ArtistModel> artists, RadioChannelsList artistListActivity) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.artist_select_view = (LinearLayout) rowView.findViewById(R.id.artist_select_view);
        holder.artist_select_view.setOnClickListener(new OnClickListener() {
            @Override
