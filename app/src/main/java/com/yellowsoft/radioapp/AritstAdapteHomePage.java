...
public class AritstAdapteHomePage extends BaseAdapter{
    String [] result;
    Context context;
    int [] imageId;
    ...
    public AritstAdapteHomePage(Activity mainActivity, ArrayList<ArtistModel> artists, HomeFragment artistListActivity) {
