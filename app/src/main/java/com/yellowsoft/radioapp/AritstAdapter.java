...
public class AritstAdapter extends BaseAdapter{
    String [] result;
    Context context;
    int [] imageId;
    ...
    public AritstAdapter(Activity mainActivity,ArrayList<ArtistModel> artists,ArtistListActivity artistListActivity) {
